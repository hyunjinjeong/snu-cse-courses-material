...
Proof.
  ...
  simpl.
  rewrite 2 optimize_0plus_sound.
  reflexivity.
  simpl.
  rewrite 2 optimize_0plus_sound.
  reflexivity.
...
Inductive no_whilesR: com -> Prop :=
  | no_0 : no_whilesR SKIP
  | no_1 : forall id e, no_whilesR (CAss id e)
  | no_2 : forall c1 c2, no_whilesR c1 -> no_whilesR c2 -> no_whilesR (CSeq c1 c2)
  | no_3 : forall b c1 c2, no_whilesR c1 -> no_whilesR c2 -> no_whilesR (CIf b c1 c2)
.

Lemma no_whiles_help:
  forall c1 c2, no_whiles (c1;; c2) = true -> no_whiles c1 = true.
Proof.
  intros.
  inversion H.
  unfold andb in H1.
...
Lemma no_whiles_help2:
  forall c1 c2, no_whiles (c1;; c2) = true -> no_whiles c2 = true.
Proof.
  intros.
  inversion H.
  unfold andb in H1.
...
Proof.
  induction c;
  try (split; intros; constructor; intros; reflexivity).
  split.
  intros.
  constructor.
  inversion IHc1.
  apply H0.
  apply no_whiles_help in H.
  apply H.
  apply no_whiles_help2 in H.
  inversion IHc2.
  apply H0 in H.
  apply H.
  intros.
  ...
  constructor.
  inversion IHc1.
  assert (true = no_whiles c1 && no_whiles c2).
  rewrite H.
  reflexivity.
  apply andb_true_eq in H2.
  inversion H2.
...
let nstack :=
  ...
  match prog with
  | [] => stack
  | instr::rest => s_execute st nstack rest
  end
.
