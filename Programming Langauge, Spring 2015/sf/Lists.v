...
Fixpoint is_mem (n:nat) (s:bag) : bool :=
  match s with
  | nil => false
  | f::r => if (is_same n f) then true
            else is_mem n r
  end.
...
Fixpoint subset (s1:bag) (s2:bag) : bool :=
  ...
  | h1::t1, nil => false
  | nil, h2::t2 => true
  | h1::t1, h2::t2 => match (is_mem h1 s2) with
...
Proof. reflexivity. Qed.
Eval compute in remove_one 1 [2;1;4;1].
Eval compute in remove_one 2 [2;4;1].
Eval compute in remove_one 2 [4;1].
...
Lemma rev_invol_1 : forall (n : nat) (l : natlist),
...
Lemma distr_rev_1 : forall l : natlist,
  l = l ++ [].
Proof.
  intros.
  induction l.
...
Lemma distr_rev_2 : forall (n: nat) (l1 l2 : natlist),
