...
Example test_split2:
  split [(1,false);(2,false);(3,true);(4,false)] = ([1;2;3;4], [false; false; true; false]).
Proof.
  reflexivity.
Qed.
...
Lemma map_rev_sub1 : forall (X Y : Type) (f : X -> Y) (x : X) (l : list X),
